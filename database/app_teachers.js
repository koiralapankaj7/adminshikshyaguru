...
//2. processing create news and events form data
	...
	function addTeacher(e) {
		...
		var storageRef = firebase.storage().ref("client-02/app-teacher/" + imageName);
...
//3. Inserting create news and events form data into firebase database
	function insertTeacher(fullName, designation, experiance, phone1, phone2, email1, email2, downloadURL, time) {
		...
		var newTeacherRef = firebase.database().ref("clients/client-02/app_teachers/teachers");
...
//4. Fetching news and events data from firebase database
	var teacherRootRef = firebase.database().ref().child("clients/client-02/app_teachers/teachers");
